...
build-alpine:
	docker build -t spip/tools:8.1.2-alpine -t spip/tools:8.1-alpine -f docker/php/cli/8.1-alpine/Dockerfile docker/php
	docker build -t spip/tools:latest-alpine -t spip/tools:8.0.15-alpine -t spip/tools:8.0-alpine -f docker/php/cli/8.0-alpine/Dockerfile docker/php
...
push-alpine:
	...
	docker push spip/tools:8.0.15-alpine
